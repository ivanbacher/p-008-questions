...
let Elevator = function(options) {
    ...
    function extendParameters(options, defaults){
        for( let option in defaults ){
            let t = options[option] === undefined && typeof option !== "function";
            if(t){
    ...
    function animateLoop( time ) {
        ...
        let easedPosition = easeInOutQuad(timeSoFar, startPosition, endPosition - startPosition, duration);
